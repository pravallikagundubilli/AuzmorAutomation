...
public class ExcelSheet{
    public static void main(String[] args) throws Exception {
        File file = new File("C:\\Users\\DELL\\Downloads\\Report.xlsx");
        ...
        for (int k = 0; k < cellCount; k++) {
            if ("Progress Status".equals(sheet.getRow(1).getCell(k).getStringCellValue())) {
                statusIndex = k;
            }
            if ("Email/Username".equals(sheet.getRow(2).getCell(k).getStringCellValue())) {
                index = k;
            }
        }
